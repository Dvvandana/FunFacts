...
my_api_key = "AIzaSyBqqiN3SHIN9CElrMmrqwvyzcKR0ErrYr4"
my_cse_id = "009395138716893887355:2gorvorgy7j"

# <script async src="https://cse.google.com/cse.js?cx=009395138716893887355:pknqtkcmva6"></script>
...
def popular_data(date_to_search,year_to_search):
    # search_query = f"{date_to_search}" 
    date_details = date_to_search.split(' ')
    month = date_details[0].lower()
    day = int(date_details[1])
